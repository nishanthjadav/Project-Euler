...
public class Euler96 {
    ...
    static boolean isNumIn3x3(int[][] grid, int num, int row, int col) // helper
    {
        ...
        int localBoxCol = col - col % 3; // to get top left index of current 3x3
    ...
    {
        String s = "300200000000107000706030500070009080900020004010800050009040301000702000000008006";
